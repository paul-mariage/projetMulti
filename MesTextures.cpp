...
MesTextures::Textures MesTextures::textures;

MesTextures::Texture MesTextures::ajouter(std::string nomFichier)
{
...
void MesTextures::supprimer(std::string nomFichier)
{
...
MesTextures::Texture MesTextures::texture(std::string nomFichier)
{
    return this->textures[nomFichier];
}

void MesTextures::chargerTexture(const char* nomFichier, GLuint* texture, sint32* largeur, sint32* hauteur)
{
    SDL_Surface *surface;
